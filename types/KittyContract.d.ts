...
interface KittyContractInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "createKittyGen0",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "Birth(address,uint256)": EventFragment;
...
export type BirthEvent = TypedEvent<
  [string, BigNumber] & { owner: string; kittyId: BigNumber }
>;
...
export class KittyContract extends BaseContract {
  ...
  filters: {
    ...
    "Birth(address,uint256)"(
      owner?: string | null,
      kittyId?: BigNumberish | null
    ): TypedEventFilter<
      [string, BigNumber],
      { owner: string; kittyId: BigNumber }
    >;
